            ...
            <div id="header" class="head-tr bottom">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        <!-- Logo -->
                        <div id="logo">
                            <a href="index.html"><img src="images/logo-white.svg" data-sticky-logo="images/logo.svg" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
        ...
        <div id="login">
            <div class="login">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <button class="btn_1 rounded full-width">Login to Listi Find</button>
                    <div class="text-center add_top_10">New to Listi Find? <strong><a href="register.html">Sign up!</a></strong></div>
                </form>
            </div>
        </div>
        <!-- END SECTION LOGIN -->
